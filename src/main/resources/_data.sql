...
INSERT INTO public.project (project_id, deadline, name, state) VALUES (5, null, 'New project with user', 'IN_PROGRESS');
INSERT INTO public.project (project_id, deadline, name, state) VALUES (12, '2021-01-03', 'EAR project', 'IN_PROGRESS');

INSERT INTO public.sprint (id, deadline, description, name, closed, project_id) VALUES (127, null, 'Specialized for creating services', 'Services sprint', false, 12);

INSERT INTO public.ear_user (dtype, id, name, password, role, username, avatar_id, removed) VALUES ('User', 69, 'Admin', '$2a$10$dWyTWEanyG6WANrnqCUW9.WuFXoWb5Gvlmzrse9QALJcnmsQuDQaO', 'ADMIN', 'admin', null, false);
INSERT INTO public.ear_user (dtype, id, name, password, role, username, avatar_id, removed) VALUES ('User', 64, 'HAASD', '$2a$10$viDpd5pi45LPcDs/44kwbOlOIYzCIHWcJ0j0XSyqK9nOM4rqIViHG', 'USER', 'gerzitomG', null, false);
INSERT INTO public.ear_user (dtype, id, name, password, role, username, avatar_id, removed) VALUES ('User', 39, 'Tom', '$2a$10$D6B.J0HnbxPdnYNReqSkjeRW32QXzBosRlnESOeqV5G2qtP4H.raq', 'USER', 'gerzitom', null, false);
INSERT INTO public.ear_user (dtype, id, name, password, role, username, avatar_id, removed) VALUES ('User', 35, 'Martin Hubal', '$2a$10$Yy4V5TiDP81x7NgDxJ6VM.iQiyd56rUjPAk0ahBCZ9wehBTFcdzQi', 'USER', 'hubalmara', null, true);
...
INSERT INTO public.project_user (id, added, project_id, user_id) VALUES (81, '2021-01-01 15:47:45.714463', 5, 39);
INSERT INTO public.project_user (id, added, project_id, user_id) VALUES (91, '2021-01-01 23:24:18.616518', 5, 64);

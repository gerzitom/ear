...
import cz.cvut.fel.ear.tm.dto.comment.CommentReadDto;
...
import cz.cvut.fel.ear.tm.service.CommentService;
import cz.cvut.fel.ear.tm.service.ProjectService;
import cz.cvut.fel.ear.tm.service.TaskService;
import cz.cvut.fel.ear.tm.service.TrackedTimeService;
...
public class TaskRestController {
    ...
    public List<TaskReadDto> getAllTasks() {
        ...
        List<TaskReadDto> userTasks = taskService.findAll(user);
    ...
    public void addComment(
        ...
        SecurityUser user = (SecurityUser) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        taskService.addComment(id, comment, user);
    ...
    public void removeUser(
        ...
        SecurityUser user = (SecurityUser) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        taskService.removeUser(taskId, userId, user);
